...
|---|---|
| Processor/I/O memory | `487424K / 36864K` |
...
| Serial WAN interface card | 1 | `HWIC-1T`, VID `V02` | Slot 0, SubSlot 0 |
...
| `Serial0/0/0` | 1 | Synchronous/asynchronous serial | `HWIC-1T`, Slot 0 SubSlot 0 |
